...
A: Two sources blurred together: an unsourced quote attributed to Andrew Carnegie, and real surveys showing most millionaires own a home. The slogan confuses owning a home with getting rich through property.

### Q: Do millionaires invest in real estate, and did Carnegie really say that line?

A: Most do hold real estate, starting with a home and often adding income property. The Carnegie quote, though, has no verified source and appears only well after his death in 1919.

### Q: What do millionaires actually invest in?

A: A primary residence, retirement accounts, business equity, securities, and some investment real estate. Property is a meaningful piece, not the dominant one, for the average millionaire.

### Q: Should I copy what millionaires do?

A: Yes on the principle: diversify across asset classes, and lean toward income-producing real estate rather than a single speculative bet. No on the mimicry: few got rich through aggressive property alone.

### Q: What is the easiest way to add real estate to a portfolio?

A: A REIT ETF for liquid exposure, a real estate debt platform for defined-maturity interest, or single-property fractional ownership for passive income from a specific building (reported on a K-1). Pick by goal and time horizon.

## Conclusion

The 90 percent figure sticks because it flatters a simple story: buy real estate, get rich. The data tells a slower one. Homeownership really is near universal among millionaires, but that reflects wealth they already had more than wealth real estate made. The Carnegie line behind the slogan was never his. And the surveys measure who owns a home, not what built the fortune.

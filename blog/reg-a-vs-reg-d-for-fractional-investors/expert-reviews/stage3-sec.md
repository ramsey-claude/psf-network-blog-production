...
**L1. The March 2025 minimum-investment guidance is correctly cited but could note it is staff guidance, not a rule change.**
The post says "the SEC clarified that issuers may rely on minimum investment amounts as a reasonable step to verify." Strictly: this was SEC staff guidance (a no-action-style clarification), not a formal rulemaking amendment to 506(c). Acceptable as written for an investor-facing piece; just noting for precision.

**L2. The Reg CF FAQ correctly states the $5 million cap.**
Cap is the post-March-2021 $5M, up from $1.07M. Accurate.

**L3. The "Reg A as mini-IPO" framing is industry-standard language.**
The SEC has not officially adopted this term, but it is the universally-used informal name. Acceptable.

## Verdict

Pass with M1 and M2 as tightening items. No HIGH issues. Post does not require Stage 2 rewrite.

...
Prior reviews considered: SEC (M1 Fundrise hybrid, M2 verification window), FINRA (M1 framework-fit balance). All MED-level, no rewrite triggers.
...
Suggested fix: clarify in the Reg CF FAQ that the investment limits are explicit retail-investor protections, distinct from the open-ended structure of Reg A Tier 2 (which has the 10% cap but is per-offering, not cumulative across offerings).

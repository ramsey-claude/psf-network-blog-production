...
Return claims uniformly soft-framed: "platform-reported", "target", "not a forecast." The post explicitly refuses to do a head-to-head return comparison and says why (vintage / fee / property-mix differences make apples-to-apples misleading). This is the right FINRA-aligned posture.

The "What should you watch out for" H2 names the four primary risks (platform, illiquidity, fee compounding, tax complexity) plus calls out the past-performance-no-forecast disclaimer.
...
RESPONSE: Agree with SEC on Mogul/staleness watch.

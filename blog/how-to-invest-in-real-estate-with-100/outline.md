# Outline: How to Invest in Real Estate with $100
...
|-----------|---------|
| Type tag | Guide |
| Topic tag | Getting Started |
| H1 | How to Invest in Real Estate with $100 (or Less) in 2026 |
| Dek | You do not need a down payment. You do not need to be wealthy. Here is the honest guide to starting a real estate portfolio with $100. |
...
**Answer capsule:** Fractional ownership, REITs, real estate ETFs, real estate crowdfunding.
**Table:** Comparison: minimum, liquidity, income frequency, effort.

### 3. Step-by-step: your first fractional investment (id: step-by-step)
**Answer capsule:** 5 steps from zero to owning a piece of a property.
...
Body: Each mistake explained with a real consequence example.

### 6. FAQ (id: faq)
1. Is $100 enough to start investing in real estate?
2. Which fractional real estate platform has the lowest minimum?
3. How long before I receive my first distribution?
4. Can I invest in real estate with $100 from outside the US?

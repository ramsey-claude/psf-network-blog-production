# Claim Inventory - how-to-invest-in-real-estate-with-100

## Numerical / platform minimum claims

| # | Claim | Section | Source target |
|---|-------|---------|---------------|
| C1 | Arrived: $100 minimum | options, what-it-buys | platform marketing + SEC EDGAR |
| C2 | Realbricks: $100 minimum | options | platform marketing |
| C3 | Ark7: $20 minimum | options, can-you | platform (cross-ref hub E11) |
...
| # | Claim | Section | Source target |
|---|-------|---------|---------------|
| C9 | Fractional platforms file under SEC Reg A or Reg D | step-by-step | cross-ref hub E1-E5 |
| C10 | LLC pass-through, K-1 reporting for US investors | step-by-step, FAQ | cross-ref hub E8 |
| C11 | REIT 90% distribution rule (for option comparison) | options | cross-ref hub E9 |
| C12 | Real estate is illiquid, multi-year hold typical | mistakes, FAQ | cross-ref hub general |

## Comparative claims

| # | Claim | Section | Source target |
|---|-------|---------|---------------|
| C13 | 4 sub-$500 options exist: fractional, REIT, REIT ETF, real estate crowdfunding | options | structural fact, SERP-supported |
| C14 | $100 arithmetic: $100 at 7% = $7/year (illustrative) | what-it-buys | arithmetic |

...
- Meta title (SEO): How to Read a Reg A Offering Circular (Investor Guide)

- Meta description: Learn how to read a Reg A offering circular step by step: the key sections, red flags, and SEC filings every fractional real estate investor should check first.

- Slug: how-to-read-reg-a-offering-circular

- Canonical URL: https://www.psfnetwork.com/blog/how-to-read-reg-a-offering-circular

- Hero visual alt text: An investor at a desk scrolling a Form 1-A offering circular on a laptop next to a printed checklist.
...
# How to Read a Reg A Offering Circular: An Investor's Field Guide
...
|---|---|---|
| Maximum raise (12 months) | Up to $20 million | Up to $75 million |
| Audited financials required | No | Yes |
| Ongoing SEC reports | No (state review applies) | Yes (1-K, 1-SA, 1-U) |
| Non-accredited investors | Allowed | Allowed, with investment limits |
| Investment limit for non-accredited | None at federal level | Capped by income or net worth |
...
None of that should be taken on faith when the filing is one search away. You can review the platform and its current offerings at [PSFnetwork](https://www.psfnetwork.com/).
...
2. U.S. Securities and Exchange Commission, Form 1-A (Regulation A Offering Statement): [https://www.sec.gov/files/form1-a.pdf](https://www.sec.gov/files/form1-a.pdf)

3. U.S. Securities and Exchange Commission, EDGAR Full-Text Search: [https://www.sec.gov/edgar/search/](https://www.sec.gov/edgar/search/)

4. Investor.gov (U.S. SEC), Regulation A: [https://www.investor.gov/introduction-investing/investing-basics/glossary/regulation-a](https://www.investor.gov/introduction-investing/investing-basics/glossary/regulation-a)

5. U.S. Securities and Exchange Commission, Ongoing Reporting Requirements for Tier 2 Issuers (Form 1-K): [https://www.sec.gov/about/forms/form1-k.pdf](https://www.sec.gov/about/forms/form1-k.pdf)

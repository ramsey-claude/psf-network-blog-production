# Outline: How to Build Passive Income with Real Estate
...
|-----------|---------|
| Type tag | Guide |
| Topic tag | Passive Income |
| H1 | How to Build Passive Income with Real Estate (Without Becoming a Landlord) |
| Dek | Rental income, appreciation, and zero maintenance calls. Here is how to build real estate passive income starting with as little as $100. |
...
**Answer capsule:** Fractional, REIT, direct rental, real estate debt.
Body: One paragraph per method, minimum, effort level, expected yield. Table comparison.

### 4. How to start with fractional real estate platforms (id: how-to-start)
**Answer capsule:** 5 steps from account to first distribution.
Body: Platform selection criteria, first investment mechanics, what to expect from first distribution.
...
**Answer capsule:** Liquidity, vacancy, platform, concentration.
Body: Honest treatment of risks without catastrophizing. How diversification mitigates each.

### 7. FAQ (id: faq)
1. Is real estate passive income really passive?
2. How long does it take to earn passive income from real estate?
3. How much do I need to invest to earn $1,000/month?
4. Is fractional real estate passive income taxed?
5. What is the safest way to earn passive income from real estate?
